      ...
      <div className={style.box}>
        <Card title='商品添加' className={style.card}>
          ...
          >
            ...
            >
              <Input value={name} placeholder='美赞臣' onChange={(e)=>{
            ...
            >
              <InputNumber min={1} placeholder={3000} max={100000} value={price} onChange={(e)=>{
            ...
            >
              <InputNumber placeholder={125} min={1} max={100000} value={stock} onChange={(e)=>{
            ...
            >
              <Input placeholder='包' style={{width:88}}  value={unit} onChange={(e)=>{
